...
<div class="card mt-2" id="po-remote-actions">
    <div class="card-header">
        <h3 class="card-header-title"><i
                    class="icon-money"></i> {l s='PlatiOnline actions for transaction ID: %s' sprintf=$trans_id d='plationline'}
        </h3>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="po6-row">
            <div class="col-sm-4">
                <button type="button" class="btn btn-primary"
                        id="query-po6">{l s='Query tranzaction' mod='plationline'}</button>
            </div>
        ...
        <div class="po6-row">
            <div class="col-sm-4">
                <button type="button" class="btn btn-primary"
                        id="void-po6">{l s='Void tranzaction' mod='plationline'}</button>
            </div>
            <div class="col-sm-8 text-right">
        ...
        <div class="po6-row">
            <div class="col-sm-4">
                <button type="button" class="btn btn-primary"
                        id="settle-po6">{l s='Settle tranzaction' mod='plationline'}</button>
            </div>
            <div class="col-sm-8 text-right">
        ...
        <div class="po6-row">
            <div class="col-sm-4 form-inline">
                <input value="{$amount|floatval}" class="po6-left form-control fixed-width-sm pull-left"
                       id="refund-po6-amount" type="number" step="0.01" min="0.01" max="{$amount|floatval}">
                <span class="po6-margin-10">{$currency|escape:"htmlall":"UTF-8"}</span>
                <button type="button" class="btn btn-primary"
                        id="refund-po6">{l s='Refund specified amount' mod='plationline'}</button>
            </div>
            <div class="col-sm-8 text-right">
